...
const TableHead = React.forwardRef(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "yh-12 ypx-4 ytext-left yalign-middle yfont-medium ytext-muted-foreground [&:has([role=checkbox])]:ypr-0",
      className
    )}
    {...props} />
))
...
const TableCell = React.forwardRef(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn("yp-4 yalign-middle [&:has([role=checkbox])]:ypr-0", className)}
    {...props} />
))
