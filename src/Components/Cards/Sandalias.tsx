    ...
    {cards3.map(card => (
        <div key={card.id} className="w-fit" >
            ...
            <div className="flex p-2 flex-col items-center justify-center mb-2">
                <h2 className="text-lg font-medium text-gray-900 w-fit justify-self-end">{card.name}</h2>
                <p className="text-base text-gray-700 w-fit">{card.description}</p>
                <div className="flex items-center justify-center">
                    <p className="mr-2 text-lg font-semibold text-gray-900 w-fit">${card.price.toFixed(2)}</p>
                    <p className="text-base font-medium text-gray-500 line-through w-fit">${card.originalPrice.toFixed(2)}</p>
