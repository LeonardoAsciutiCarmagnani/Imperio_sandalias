...
export default function FormPayment(){
    ...
    return (
    <div className="flex w-full bg-red-400 justify-center">
    <div className="w-full bg-gray-50 py-5 flex flex-col items-center">
    <div className="px-5">
        {/* <div className="mb-2">
        ...
        <div className="mb-2">
            <h1 className="text-3xl md:text-5xl font-bold text-gray-600 pb-3">Pagamento</h1>
        </div>
                ...
                <div className="px-3 md:w-7/12 lg:pr-10">
                    ...
                    <div className="mb-6 pb-6 border-b border-gray-200 md:border-none text-gray-800 text-xl">
                        <div className="w-full flex items-center">
                            ...
                            <div className="pl-3">
                                <span className="font-semibold text-gray-400 text-sm">BRL</span> <span className="font-semibold">R$210.00</span>
                            </div>
                        </div>
                    </div>
                </div>
